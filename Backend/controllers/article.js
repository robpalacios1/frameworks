...
var controller = {
    ...
    upload: (req, res) => {
        // configuar modulo connect multiparty router/article.js
        ...
        // Conseguir nombre y extension de archivos
        ...
        if(file_ext != 'png' && file_ext != 'jpg' && file_ext != 'jpeg' && file_ext != 'gif') {
            ...
            var articleId = req.params.id;
            // Buscar aticulo, asignarle el nombre de la imagen y actualizarlo
